...
#latent_spaces_path = f'/fp/projects01/ec332/data/latent_spaces/file_{window}_{threshold}_sam2.npz'
...
full_power_spectrograms_path = f'spectrograms/power_spec_{station}_{window}_{threshold}.npz' #_{station}
...
output_file(f"/fp/projects01/ec332/data/tsne_plots/file_no_res_{station}_{window}_{threshold}_model_{num_epochs}_{weight}_{learning_rate}_{batch_size}_{bottle}_cluster_{perplexity}_{init}_mod.html")
save(p)
