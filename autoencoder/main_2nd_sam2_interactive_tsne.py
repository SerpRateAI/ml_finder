...
latent_spaces_path = f"/fp/projects01/ec332/data/latent_spaces/file_{window}_{threshold}_model_{num_epochs}_{weight}_{learning_rate}_{batch_size}_{bottle}_2nd_sam.npz"
...
output_file(f"/fp/projects01/ec332/data/tsne_plots/file_{station}_{window}_{threshold}_model_{num_epochs}_{weight}_{learning_rate}_{batch_size}_{bottle}_cluster_{perplexity}_{init}_sam2_moddb.html")
save(p)
